    ...
    return (
        <>
            <div id='myBizHeader'>
                ...
                {reviews.length != 0 && <h4>Here&apos;s a look at your Reviews</h4>}
            </div>
                ...
                {reviews.length ? reviews.map(review =>
                    <div key={review.id} className='reviewTiles'>
                        ...
                        <div className='myReviewButtonsContainer'>
                            <OpenModalButton
                                buttonText='Update'
                                modalComponent={<UpdateReviewModal reviewId={review.id} business={businesses[review.business_id]} stSlice='user'/>}
                            />
                            <OpenModalMenuItem
                                className='redBtn'
                                itemText="Delete"
                        ...
                        <div className='noBizContent'>
                            ...
                            <div className='noBizContentDetails'>
                                ...
                                <div className='noBizContentText'>
                                    <span>
                                        <h4>Looks like you haven&apos;t reviewed any businesses yet</h4>
                                    </span>
                                    <p>Let&apos;s go checkout some businesses!</p>
                                    <button
